  ...
  return (
    ...
    >
      ...
      <div
        ...
        duration-400 hover:bg-indigo-600 group:transition-all group:ease-in-out group:duration-200 
        group
        "
      >
        <button
          onClick={onStarted}
          className="text-[4rem] m-0 mb-2 text-white group-hover:scale-105 transition-all ease-in-out duration-200"
        >
          Let's Connect
        </button>
      </div>
